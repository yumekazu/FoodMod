...
public class CookingPotScreen extends AbstractContainerScreen<CookingPotMenu> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(FoodMod.MOD_ID, "textures/gui/cookingpot_gui.png");
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 102, y + 34, 176, 10, menu.getScaledProgress(), 17);
        }
    }
